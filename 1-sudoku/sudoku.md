...
We've provided you with some [skeleton code](sudoku.rb) if you're interested, otherwise feel free to tackle it all on your own. Please do try and meet the objectives of the release though as we will build on it later in the challenge.

Your Sudoku solver should take a string like this as its input (you can use sample.unsolved.txt:
...
###Release 2 : Implement a guessing-friendly version of Sudoku

We now want to add the ability to make guessing.
