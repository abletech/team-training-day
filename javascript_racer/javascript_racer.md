...
single html page with no back-end at all.  Later (if you get to it) we'll add the ability to save
high scores and the like by adding a back-end to the application.

The game will be palyed out on a fixed track and the outcome of the game won't be pure chance - you're gonna need mad skill.  Each player
